(() => {
        ...
        const Pe = { getIconUrl() {
          ...
          if ("captions" === e2)
            ...
            if (n2 = S.empty(i2) ? this[e2] : i2, S.empty(n2) && (n2 = this.config[e2].default), !S.empty(this.options[e2]) && !this.options[e2].includes(n2))
              return void this.debug.warn("Unsupported value of '".concat(n2, "' for ").concat(e2));
            if (!this.config[e2].options.includes(n2))
              return void this.debug.warn("Disabled value of '".concat(n2, "' for ").concat(e2));
          }
  ...
  // assets/js/modules/bubble.js
  var miniBubble = document.createElement("span");
  miniBubble.classList.add("mini-bubble");
  var appendMiniBubble = (count, parent) => {
  ...
  var seoSwiper = new Swiper("#seoMainSwiper", {
    modules: [EffectFade, Mousewheel],
    slidesPerView: 1,
    effect: "fade",
    fadeEffect: {
  ...
  var _initCore3 = function _initCore4(core) {
    ...
    if (gsap2) {
      ...
      for (p in EasePack) {
        p !== "version" && gsap2.core.globals(p, EasePack[p]);
      }
      _coreInitted2 = 1;
    }
  };
  ...
  var _createRoughEase = function _createRoughEase2(vars) {
    ...
    var taper = vars.taper || "none", a = [], cnt = 0, points = (+vars.points || 20) | 0, i = points, randomize = _boolean(vars.randomize, true), clamp3 = _boolean(vars.clamp), template = gsap2 ? gsap2.parseEase(vars.template) : 0, strength = (+vars.strength || 1) * 0.4, x, y, bump, invX, obj, pnt, recent;
    while (--i > -1) {
  ...
  for (p in EasePack) {
    EasePack[p].register = _initCore3;
  ...
  _getGSAP3() && gsap3.registerPlugin(Observer2);
  ...
  var _buildGetter = function _buildGetter2(e, axis) {
    ...
    if (e === _window) {
      if (e.pageXOffset != null) {
        ...
        e = _docEl2[p] != null ? _docEl2 : _body2;
      }
    }
    return function() {
      return e[p];
  ...
  var _initCore7 = function _initCore8() {
    gsap4 = _getGSAP5();
    if (_windowExists5() && gsap4 && typeof document !== "undefined" && document.body) {
      _window = window;
  ...
  var ScrollToPlugin = {
    ...
    init: function init4(target, value, tween, index, targets) {
      ...
      ScrollTrigger2 || (ScrollTrigger2 = gsap4.core.globals().ScrollTrigger);
  ...
  var ScrollTrigger3 = /* @__PURE__ */ function() {
    function ScrollTrigger4(vars, animation) {
      _coreInitted5 || ScrollTrigger4.register(gsap5) || console.warn("Please gsap.registerPlugin(ScrollTrigger)");
      _context3(this);
    ...
    _proto.init = function init5(vars, animation) {
      ...
      if (snap3) {
        ...
        "scrollBehavior" in _body3.style && gsap5.set(isViewport ? [_body3, _docEl3] : scroller, {
          scrollBehavior: "auto"
        });
    ...
    ScrollTrigger4.enable = function enable() {
      ...
      if (gsap5) {
        ...
        if (_body3) {
          ...
          var bodyStyle = _body3.style, border = bodyStyle.borderTopStyle, AnimationProto = gsap5.core.Animation.prototype, bounds, i;
  ...
  ScrollTrigger3.refresh = function(safe) {
    return safe ? _onResize() : (_coreInitted5 || ScrollTrigger3.register()) && _refreshAll(true);
  };
  ...
  _getGSAP7() && gsap5.registerPlugin(ScrollTrigger3);
  ...
  var PreloaderHome = () => {
    ...
    const bottomFire2 = document.querySelector(".bottom-fire");
    ...
    if (!clockEl || !preClockScrollDown || !clockSection || !clockInnerElements || !letsGo || !bottomFire2 || !multiPlanetSection || !multiPlanetGroup)
      return;
    const clockSpinTL = gsapWithCSS.timeline();
    const preloader_TL = gsapWithCSS.timeline({ defaults: { duration: 1 } });
    ...
    preloader_TL.to(".pre-clock , .clock-section, .clock", {
      y: window.innerHeight * -1,
      duration: 3,
      onComplete: startMultiPlanet
    }).addLabel("endOfSlide2");
    preloader_TL.addLabel("startMultiPlanet").add(multiPlanet_TL).addLabel("endMultiPlanet");
  ...
  // assets/js/pages/front-page/projects.js
  var HomeProject = () => {
    ...
    const projectOnHover_TL = gsapWithCSS.timeline({ defaults: { duration: 0.5 } });
    const projectOnHover_Run = () => {
      projectOnHover_TL.from(".project-on-hover", { opacity: 0, y: 60 });
      gsapWithCSS.utils.toArray(".project-on-hover .head .right-col > *").forEach((el) => {
        projectOnHover_TL.from(el, { opacity: 0, y: 30 }, "-=0.3");
      });
      gsapWithCSS.utils.toArray(".project-on-hover .head .left-col > *").forEach((el) => {
