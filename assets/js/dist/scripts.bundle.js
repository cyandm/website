(() => {
  ...
  var require_comments = __commonJS({
    "assets/js/modules/comments.js"() {
      ...
      var blog_commentOpener = document.getElementById("blog_comment");
      if (!overlay) return;
      commentOpener == null ? void 0 : commentOpener.addEventListener("click", (event2) => {
      ...
      comment_back.addEventListener("click", (event2) => {
        overlay.classList.add("invisible");
        overlay.classList.add("opacity-0");
      });
      blog_commentOpener == null ? void 0 : blog_commentOpener.addEventListener("click", (e) => {
        overlay.classList.remove("invisible");
        overlay.classList.remove("opacity-0");
      });
  ...
  var toggleShow = (el, isAddClass) => {
    ["visible", "pointer-all"].map((cls) => {
      el == null ? void 0 : el.classList.toggle(cls, isAddClass);
    });
  };
  var toggleFadeOff = (el, isAddClass) => {
    el == null ? void 0 : el.classList.toggle("fade-off", isAddClass);
  };
  var activate = (el) => {
    el == null ? void 0 : el.classList.add("active");
  };
  var deactivate = (el) => {
    el == null ? void 0 : el.classList.remove("active");
  };
  ...
  var MobileMenu = () => {
    ...
    menuItemHasChildren == null ? void 0 : menuItemHasChildren.forEach((el) => {
  ...
  var teamdetail = document.querySelectorAll(".front");
  var card = document.querySelectorAll(".employ-card");
  var behindcard = document.querySelectorAll(".behind-card");
  ...
  var employ_back = document.querySelectorAll(".behind-card");
  ...
  var faq_card = document.querySelectorAll(".faq-card__title-wrapper");
  ...
  var faq_card_wrapper = document.querySelectorAll(
  ...
  // assets/js/modules/project-button.js
  var OpenButton = document.querySelector(".open-button");
  var projectbutton = document.querySelector(".project-button");
  OpenButton == null ? void 0 : OpenButton.addEventListener("click", () => {
    projectbutton.classList.toggle("active");
  });

  // assets/js/modules/search.js
  var separator2 = document.querySelector(".separator");
  if (separator2) {
    separator2.innerHTML = '<svg class="icon" style="width:40px;height:36px"><use href="#icon-Arrow-6" /></svg>';
  }
  var SearchPage = () => {
    ...
    projectsSearch == null ? void 0 : projectsSearch.addEventListener("click", (event2) => {
    ...
    blogsSearch == null ? void 0 : blogsSearch.addEventListener("click", (event2) => {
    ...
    allSearch == null ? void 0 : allSearch.addEventListener("click", (event2) => {
